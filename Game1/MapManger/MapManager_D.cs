...
namespace Imprisoned_Hope
{
    public partial class MapManager
    {
        ...
        public void SetTypesAndTextures()
        {
            ...
            TextureList.Add(Hra.Content.Load<Texture2D>(@"Textury\Objects\brick_wall_nicked"));
            ...
            TextureList.Add(Hra.Content.Load<Texture2D>(@"Textury\Objects\grayBrick wall"));
            TextureList.Add(Hra.Content.Load<Texture2D>(@"Textury\Objects\grayBrick2 wall"));
            TextureList.Add(Hra.Content.Load<Texture2D>(@"Textury\Objects\bed_head_top"));
            TextureList.Add(Hra.Content.Load<Texture2D>(@"Textury\Objects\bed_feet_top"));
