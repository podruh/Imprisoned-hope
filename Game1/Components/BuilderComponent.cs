...
namespace Imprisoned_Hope
{
    ...
    public class BuilderComponent : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            #region Blocky
            brickWall = Hra.Content.Load<Texture2D>(@"Textury\Objects\brick_wall_nicked");
            ...
            grayBrick = Hra.Content.Load<Texture2D>(@"Textury\Objects\grayBrick wall");
            grayBrick2 = Hra.Content.Load<Texture2D>(@"Textury\Objects\grayBrick2 wall");
            bedHead = Hra.Content.Load<Texture2D>(@"Textury\Objects\bed_head_top");
            bedFeet = Hra.Content.Load<Texture2D>(@"Textury\Objects\bed_feet_top");
            ...
            FontCourierNew = Hra.Content.Load<SpriteFont>(@"font_courier_new");            
